...
object testMain extends App {
    ...
    // (new chisel3.stage.ChiselStage).execute(Array("--target-dir","generated/bus_slave_mux"),
    //     Seq(ChiselGeneratorAnnotation(() => new bus_slave_mux)))

    // (new chisel3.stage.ChiselStage).execute(Array("--target-dir","generated/bus"),
    //     Seq(ChiselGeneratorAnnotation(() => new bus)))
}